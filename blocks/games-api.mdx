---
title: 'Games API (RAWG)'
description: 'A API that have a very large games database. The cool thing about this API is that they can provide you trailers and YouTube videos about all of the games.'
icon: 'code'
---

# Why to use RAWG (From their website)

<b>Why build on RAWG</b>  
...
[Get your own API key](https://rawg.io/apidocs)
...
## Get twitch streams related to a specific game
```ts index.ts
axios
...
## Get YouTube videos related to a specific game
```ts index.ts
axios
...
For more examples or other implementations check out the [official documentation](https://api.rawg.io/docs)
